    ...
    <div className="Home">
      ...
      <div className="Home__Dates">
        ...
        <ul>
          ...
          <li><del><strong>Early Bird Tickets - Round One</strong> {moment.utc(constants.Dates.TICKET_RELEASE).subtract(14, 'days').format('[12:00pm MDT], MMMM DD, YYYY')} ($300)</del></li>
          <li><del><strong>Early Bird Tickets - Round Two</strong> {moment.utc(constants.Dates.TICKET_RELEASE).subtract(7, 'days').format('[12:00pm MDT], MMMM DD, YYYY')} ($350)</del></li>
          <li><strong>Standard Tickets</strong> {moment.utc(constants.Dates.TICKET_RELEASE).format('[12:00pm MDT], MMMM DD, YYYY')} ($400)</li>
        </ul>
      </div>
